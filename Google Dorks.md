...
Busca Avançada Google: https://www.google.com/advanced_search

Busca Avançada de Imagens Google: https://www.google.com/advanced_image_search

**intitle:login site:eccouncil.org**. This search command uses **intitle** and **site** Google advanced operators, which restrict results to pages on the **eccouncil.org** website that contain the **login** pages. 

type the command **EC-Council filetype:pdf ceh** in the search bar to search your results based on the file extension and the keyword (here, **ceh**). Click on any link from the results (here, **CEH-brochure.pdf**) to view the pdf file
...
![[Pasted image 20250322103136.png]]

![[Pasted image 20250322103206.png]]
![[Pasted image 20250322103234.png]]
